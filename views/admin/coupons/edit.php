...
<div class="content-wrapper">
    ...
    <section class="content">
        <form action="?act=coupon-update&coupon_id=<?= $coupon['coupon_id'] ?>" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status" value="hidden" <?= $coupon['status'] == 'hidden' ? 'checked' : '' ?> id="status_hidden">
                                    <label class="form-check-label" for="status_hidden">Đã hết hạn</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status" value="active" <?= $coupon['status'] == 'active' ? 'checked' : '' ?> id="status_active" checked>
                                    <label class="form-check-label" for="status_active">Đang hoạt động</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status" value="future plan" <?= $coupon['status'] == 'future plan' ? 'checked' : '' ?> id="status_future_plan">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="<?= $coupon['name'] ?>" placeholder="Nhập tên mã giảm giá" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="coupons_code" value="<?= $coupon['coupons_code'] ?>" placeholder="Nhập mã giảm giá" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="quantity" value="<?= $coupon['quantity'] ?>" placeholder="Nhập số lượng" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="type" <?= $coupon['coupons_type'] == 'Percentage' ? 'checked' : '' ?> value="Percentage" id="type_percentage">
                                    <label class="form-check-label" for="type_percentage">Giảm phần trăm</label>
                                </div>
                                <div class="form-check"> 
                                    <input class="form-check-input" type="radio" name="type" <?= $coupon['coupons_type'] == 'Fixed Amount' ? 'checked' : '' ?> value="Fixed Amount" id="type_fixed_amount">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="coupon_value" value="<?= $coupon['coupon_value'] ?>" placeholder="Nhập giá trị giảm" class="form-control">
